  ...
  story: {
    ...
    content: [
      [
        ...
        { character: '動物', english: 'animal', isVocab: true },
        { character: '園', english: 'park' },
        { character: '。', english: '', isPunctuation: true },
      ],
      [
        { character: '我', english: 'I' },
        { character: '看到', english: 'see' },
      ...
      [
        ...
        { character: '水', english: 'water' },
        { character: '裡', english: 'in' },
        { character: '游', english: 'swim' },
        { character: '，', english: '', isPunctuation: true },
        { character: '鳥', english: 'bird', isVocab: true },
        { character: '在', english: 'is' },
        { character: '天', english: 'sky' },
        { character: '上', english: 'above' },
        { character: '飛', english: 'fly' },
        { character: '。', english: '', isPunctuation: true },
      ],
      [
